...
const Mt = vueExports.ref(0), ee = vueExports.ref(1), D = vueExports.ref({}), ne = vueExports.ref(0), Gt = vueExports.ref({}), rt = {}, be = typeof window > "u";
function po(e, t, r) {
...
const $i = vueExports.ref({}), Ei = (e) => $i.value[e], bo = (e) => Object.keys(Ei.value[e]).length > 0, Ti = vueExports.ref({}), wo = (e) => Ti.value[e], xi = vueExports.ref({}), So = (e) => xi.value[e], nt = vueExports.ref([]);
function Oo(e) {
  nt.value.push(e);
}
const $o = vueExports.computed(() => fo(nt.value));
function Eo(e) {
  nt.value[e].dismissed = true, nt.value[e].html = null;
}
const Hr = vueExports.ref(null);
...
const oe = {
  ...
  setup(e) {
    ...
    return v.setOnHead((d) => {
      ...
      n.value[v.currentStack.value] && (a.value = false), n.value[v.currentStack.value] = { html: d, type: h }, vueExports.nextTick(() => {
        a.value = true;
      });
    ...
    }), (d, h) => (vueExports.openBlock(), vueExports.createElementBlock("div", null, [
      vueExports.unref(v).isSsr ? (vueExports.openBlock(), vueExports.createBlock(oe, {
        ...
        (vueExports.openBlock(), vueExports.createBlock(oe, {
          key: `visit.${vueExports.unref(v).pageVisitId.value}`,
          style: vueExports.normalizeStyle(vueExports.unref(l)),
          html: r.value
        }, null, 8, ["style", "html"]))
      ], 1032, ["max"])),
      vueExports.createVNode(oe, { html: e.components }, null, 8, ["html"]),
      (vueExports.openBlock(true), vueExports.createElementBlock(vueExports.Fragment, null, vueExports.renderList(vueExports.unref(v).currentStack.value, (p) => (vueExports.openBlock(), vueExports.createBlock(oe, {
        key: `modal.${p}`,
        type: n.value[p].type,
        html: n.value[p].html,
        stack: p,
...
function fr({ props: e, attrs: t, slots: r, slot: n, name: i }) {
  ...
  if (n) {
    ...
    for (let [d, h] of Object.entries(n))
      typeof h == "boolean" && (f = true), h === true && m.push(d);
...
`)].join(`
`));
      let d = Ri((a = f.props) != null ? a : {}, l), h = vueExports.cloneVNode(f, d);
      for (let p in d)
...
function Jr() {
  return vueExports.inject(Vi, null);
}
function Kl(e) {
  vueExports.provide(Vi, e);
}
class Yl {
  constructor() {
...
let vt = Object.assign(vueExports.defineComponent({ name: "FocusTrap", props: { as: { type: [Object, String], default: "div" }, initialFocus: { type: Object, default: null }, features: { type: Number, default: 30 }, containers: { type: Object, default: vueExports.ref(/* @__PURE__ */ new Set()) } }, inheritAttrs: false, setup(e, { attrs: t, slots: r, expose: n }) {
  let i = vueExports.ref(null);
  n({ el: i, $el: i });
  let s = vueExports.computed(() => ut(i));
  lu({ ownerDocument: s }, vueExports.computed(() => Boolean(e.features & 16)));
  let a = uu({ ownerDocument: s, container: i, initialFocus: vueExports.computed(() => e.initialFocus) }, vueExports.computed(() => Boolean(e.features & 2)));
  cu({ ownerDocument: s, container: i, containers: e.containers, previousActiveElement: a }, vueExports.computed(() => Boolean(e.features & 8)));
  let o = au();
  function l(m) {
    let d = de(i);
    !d || ((h) => h())(() => {
  ...
  return () => {
    ...
    return vueExports.h(vueExports.Fragment, [Boolean(h & 4) && vueExports.h(wr, { as: "button", type: "button", "data-headlessui-focus-guard": true, onFocus: l, features: Vt.Focusable }), K({ ourProps: d, theirProps: { ...t, ...w }, slot: m, attrs: t, slots: r, name: "FocusTrap" }), Boolean(h & 4) && vueExports.h(wr, { as: "button", type: "button", "data-headlessui-focus-guard": true, onFocus: l, features: Vt.Focusable })]);
  };
} }), { features: zi });
...
function du(e, t = vueExports.ref(true)) {
...
function fu() {
  return vueExports.inject(Xi, false);
}
let Sr = vueExports.defineComponent({ name: "ForcePortalRoot", props: { as: { type: [Object, String], default: "template" }, force: { type: Boolean, default: false } }, setup(e, { slots: t, attrs: r }) {
  return vueExports.provide(Xi, e.force), () => {
    let { force: n, ...i } = e;
...
let Ki = vueExports.defineComponent({ name: "Portal", props: { as: { type: [Object, String], default: "div" } }, setup(e, { slots: t, attrs: r }) {
  let n = vueExports.ref(null), i = vueExports.computed(() => ut(n)), s = fu(), a = vueExports.inject(Yi, null), o = vueExports.ref(s === true || a == null ? pu(n.value) : a.resolveTarget());
  return vueExports.watchEffect(() => {
    ...
    return vueExports.h(vueExports.Teleport, { to: o.value }, K({ ourProps: l, theirProps: e, slot: {}, attrs: r, slots: t, name: "Portal" }));
  };
} }), Yi = Symbol("PortalGroupContext"), hu = vueExports.defineComponent({ name: "PortalGroup", props: { as: { type: [Object, String], default: "template" }, target: { type: Object, default: null } }, setup(e, { attrs: t, slots: r }) {
  let n = vueExports.reactive({ resolveTarget() {
    return e.target;
  } });
  return vueExports.provide(Yi, n), () => {
    let { target: i, ...s } = e;
...
function yu({ slot: e = vueExports.ref({}), name: t = "Description", props: r = {} } = {}) {
...
vueExports.defineComponent({ name: "Description", props: { as: { type: [Object, String], default: "p" }, id: { type: String, default: () => `headlessui-description-${Qe()}` } }, setup(e, { attrs: t, slots: r }) {
  let n = gu();
  return vueExports.onMounted(() => vueExports.onUnmounted(n.register(e.id))), () => {
    let { name: i = "Description", slot: s = vueExports.ref({}), props: a = {} } = n, { id: o, ...l } = e, u = { ...Object.entries(a).reduce((c, [f, m]) => Object.assign(c, { [f]: vueExports.unref(m) }), {}), id: o };
...
function Tu(e, t, r) {
  let n = bu(He), i = vueExports.computed(() => {
...
let Ct = "DC8F892D-2EBD-447C-A4C8-A03058436FF4", en = vueExports.defineComponent({ name: "Dialog", inheritAttrs: false, props: { as: { type: [Object, String], default: "div" }, static: { type: Boolean, default: false }, unmount: { type: Boolean, default: true }, open: { type: [Boolean, String], default: Ct }, initialFocus: { type: Object, default: null }, id: { type: String, default: () => `headlessui-dialog-${Qe()}` } }, emits: { close: (e) => true }, setup(e, { emit: t, attrs: r, slots: n, expose: i }) {
  var s;
  let a = vueExports.ref(false);
  vueExports.onMounted(() => {
    a.value = true;
  });
  let o = vueExports.ref(0), l = Jr(), u = vueExports.computed(() => e.open === Ct && l !== null ? (l.value & W.Open) === W.Open : e.open), c = vueExports.ref(/* @__PURE__ */ new Set()), f = vueExports.ref(null), m = vueExports.ref(null), d = vueExports.computed(() => ut(f));
  ...
  let h = vueExports.computed(() => a.value && u.value ? 0 : 1), p = vueExports.computed(() => h.value === 0), g = vueExports.computed(() => o.value > 1), w = vueExports.inject($r, null) !== null, T = vueExports.computed(() => g.value ? "parent" : "leaf"), _ = vueExports.computed(() => l !== null ? (l.value & W.Closing) === W.Closing : false), S = vueExports.computed(() => !g.value || _.value ? false : p.value);
  du(f, S), vu({ type: "Dialog", enabled: vueExports.computed(() => h.value === 0), element: f, onUpdate: (x, E, B) => {
    if (E === "Dialog")
      return ce(x, { [Or.Add]() {
  ...
  let O = yu({ name: "DialogDescription", slot: vueExports.computed(() => ({ open: u.value })) }), y = vueExports.ref(null), $ = { titleId: y, panelRef: vueExports.ref(null), dialogState: h, setTitleId(x) {
    y.value !== x && (y.value = x);
  }, close() {
    t("close", false);
  } };
  vueExports.provide($r, $);
  function A() {
    var x, E, B;
  ...
  let q = vueExports.computed(() => !(!p.value || g.value));
  nu(() => A(), (x, E) => {
    $.close(), vueExports.nextTick(() => E == null ? void 0 : E.focus());
  }, q);
  let k = vueExports.computed(() => !(g.value || h.value !== 0));
  ...
  let I = vueExports.computed(() => !(_.value || h.value !== 0 || w));
  return Tu(d, I, (x) => {
    var E;
    return { containers: [...(E = x.containers) != null ? E : [], A] };
  }), vueExports.watchEffect((x) => {
    if (h.value !== 0)
      return;
    let E = de(f);
    if (!E)
    ...
    let { id: x, open: E, initialFocus: B, ...C } = e, F = { ...r, ref: f, id: x, role: "dialog", "aria-modal": h.value === 0 ? true : void 0, "aria-labelledby": y.value, "aria-describedby": O.value }, V = { open: h.value === 0 };
    return vueExports.h(Sr, { force: true }, () => [vueExports.h(Ki, () => vueExports.h(hu, { target: f.value }, () => vueExports.h(Sr, { force: false }, () => vueExports.h(vt, { initialFocus: B, containers: c, features: p.value ? ce(T.value, { parent: vt.features.RestoreFocus, leaf: vt.features.All & ~vt.features.FocusLock }) : vt.features.None }, () => K({ ourProps: F, theirProps: C, slot: V, attrs: r, slots: n, visible: h.value === 0, features: Nt.RenderStrategy | Nt.Static, name: "Dialog" }))))), vueExports.h(wr, { features: Vt.Hidden, ref: m })]);
  };
} });
vueExports.defineComponent({ name: "DialogOverlay", props: { as: { type: [Object, String], default: "div" }, id: { type: String, default: () => `headlessui-dialog-overlay-${Qe()}` } }, setup(e, { attrs: t, slots: r }) {
...
vueExports.defineComponent({ name: "DialogBackdrop", props: { as: { type: [Object, String], default: "div" }, id: { type: String, default: () => `headlessui-dialog-backdrop-${Qe()}` } }, inheritAttrs: false, setup(e, { attrs: t, slots: r, expose: n }) {
  let i = _t("DialogBackdrop"), s = vueExports.ref(null);
  return n({ el: s, $el: s }), vueExports.onMounted(() => {
    if (i.panelRef.value === null)
      throw new Error("A <DialogBackdrop /> component is being used, but a <DialogPanel /> component is missing.");
  }), () => {
    let { id: a, ...o } = e, l = { id: a, ref: s, "aria-hidden": true };
    return vueExports.h(Sr, { force: true }, () => vueExports.h(Ki, () => K({ ourProps: l, theirProps: { ...t, ...o }, slot: { open: i.dialogState.value === 0 }, attrs: t, slots: r, name: "DialogBackdrop" })));
  };
} });
let tn = vueExports.defineComponent({ name: "DialogPanel", props: { as: { type: [Object, String], default: "div" }, id: { type: String, default: () => `headlessui-dialog-panel-${Qe()}` } }, setup(e, { attrs: t, slots: r, expose: n }) {
...
vueExports.defineComponent({ name: "DialogTitle", props: { as: { type: [Object, String], default: "h2" }, id: { type: String, default: () => `headlessui-dialog-title-${Qe()}` } }, setup(e, { attrs: t, slots: r }) {
...
let es = Nt.RenderStrategy, ct = vueExports.defineComponent({ props: { as: { type: [Object, String], default: "div" }, show: { type: [Boolean], default: null }, unmount: { type: [Boolean], default: true }, appear: { type: [Boolean], default: false }, enter: { type: [String], default: "" }, enterFrom: { type: [String], default: "" }, enterTo: { type: [String], default: "" }, entered: { type: [String], default: "" }, leave: { type: [String], default: "" }, leaveFrom: { type: [String], default: "" }, leaveTo: { type: [String], default: "" } }, emits: { beforeEnter: () => true, afterEnter: () => true, beforeLeave: () => true, afterLeave: () => true }, setup(e, { emit: t, attrs: r, slots: n, expose: i }) {
  ...
  let c = vueExports.ref(null), f = vueExports.ref("visible"), m = vueExports.computed(() => e.unmount ? Pe.Unmount : Pe.Hidden);
  i({ el: c, $el: c });
  let { show: d, appear: h } = qu(), { register: p, unregister: g } = Cu(), w = { value: true }, T = Qe(), _ = { value: false }, S = Zi(() => {
    !_.value && f.value !== "hidden" && (f.value = "hidden", g(T), u());
  });
  vueExports.onMounted(() => {
    let E = p(T);
    vueExports.onUnmounted(E);
  ...
  return vueExports.onMounted(() => {
    vueExports.watch([d], (E, B, C) => {
      x(C), w.value = false;
    }, { immediate: true });
  }), vueExports.provide(nn, S), Kl(vueExports.computed(() => ce(f.value, { visible: W.Open, hidden: W.Closed }) | s.value)), () => {
    let { appear: E, show: B, enter: C, enterFrom: F, enterTo: V, entered: ft, leave: $e, leaveFrom: pt, leaveTo: At, ...Ee } = e, Je = { ref: c }, Te = { ...Ee, ...h && d && xt.isServer ? { class: vueExports.normalizeClass([Ee.class, ...O, ...y]) } : {} };
    return K({ theirProps: Te, ourProps: Je, slot: {}, slots: n, attrs: r, features: es, visible: f.value === "visible", name: "TransitionChild" });
  };
} }), Fu = ct, dt = vueExports.defineComponent({ inheritAttrs: false, props: { as: { type: [Object, String], default: "div" }, show: { type: [Boolean], default: null }, unmount: { type: [Boolean], default: true }, appear: { type: [Boolean], default: false }, enter: { type: [String], default: "" }, enterFrom: { type: [String], default: "" }, enterTo: { type: [String], default: "" }, entered: { type: [String], default: "" }, leave: { type: [String], default: "" }, leaveFrom: { type: [String], default: "" }, leaveTo: { type: [String], default: "" } }, emits: { beforeEnter: () => true, afterEnter: () => true, beforeLeave: () => true, afterLeave: () => true }, setup(e, { emit: t, attrs: r, slots: n }) {
  let i = Jr(), s = vueExports.computed(() => e.show === null && i !== null ? (i.value & W.Open) === W.Open : e.show);
  vueExports.watchEffect(() => {
    if (![true, false].includes(s.value))
      throw new Error('A <Transition /> is used but it is missing a `:show="true | false"` prop.');
  });
  let a = vueExports.ref(s.value ? "visible" : "hidden"), o = Zi(() => {
    a.value = "hidden";
  ...
  return vueExports.onMounted(() => {
    ...
    return K({ ourProps: { ...f, as: "template" }, theirProps: {}, slot: {}, slots: { ...n, default: () => [vueExports.h(Fu, { onBeforeEnter: () => t("beforeEnter"), onAfterEnter: () => t("afterEnter"), onBeforeLeave: () => t("beforeLeave"), onAfterLeave: () => t("afterLeave"), ...r, ...f, ...c }, n.default)] }, attrs: {}, features: es, visible: a.value === "visible", name: "Transition" });
  };
} });
const Lu = {
  props: {
...
function cn(e, t) {
  t === void 0 && (t = {});
  var r = t, n = r.placement, i = n === void 0 ? e.placement : n, s = r.strategy, a = s === void 0 ? e.strategy : s, o = r.boundary, l = o === void 0 ? lc : o, u = r.rootBoundary, c = u === void 0 ? os : u, f = r.elementContext, m = f === void 0 ? gt : f, d = r.altBoundary, h = d === void 0 ? false : d, p = r.padding, g = p === void 0 ? 0 : p, w = Fc(typeof g != "number" ? g : Lc(g, ir)), T = m === gt ? uc : gt, _ = e.rects.popper, S = e.elements[h ? T : m], O = Cc(Ge(S) ? S : S.contextElement || De(e.elements.popper), l, c, a), y = st(e.elements.reference), $ = us({
    reference: y,
    element: _,
    strategy: "absolute",
    placement: i
...
function Jc(e) {
  var t = e.state, r = e.options, n = e.name, i = r.mainAxis, s = i === void 0 ? true : i, a = r.altAxis, o = a === void 0 ? false : a, l = r.boundary, u = r.rootBoundary, c = r.altBoundary, f = r.padding, m = r.tether, d = m === void 0 ? true : m, h = r.tetherOffset, p = h === void 0 ? 0 : h, g = cn(t, {
    boundary: l,
    rootBoundary: u,
    padding: f,
    altBoundary: c
...
function id(e) {
  ...
  if (!t.modifiersData[n]._skip) {
    for (var i = r.mainAxis, s = i === void 0 ? true : i, a = r.altAxis, o = a === void 0 ? true : a, l = r.fallbackPlacements, u = r.padding, c = r.boundary, f = r.rootBoundary, m = r.altBoundary, d = r.flipVariations, h = d === void 0 ? true : d, p = r.allowedAutoPlacements, g = t.options.placement, w = ve(g), T = w === g, _ = l || (T || !h ? [jt(g)] : nd(g)), S = [g].concat(_).reduce(function(Te, xe) {
...
const ud = /* @__PURE__ */ Be(ad, [["render", ld]]), cd = {
  ...
  setup(e) {
    ...
    return (n, i) => vueExports.unref(t).isSsr ? (vueExports.openBlock(), vueExports.createBlock(oe, {
      key: e.keepAliveKey,
...
function Df(e, t, r, n, i, s) {
  return vueExports.openBlock(), vueExports.createElementBlock("div", kf, [
    vueExports.renderSlot(e.$slots, "default", {
...
function sp(e, t, r, n, i, s) {
  return vueExports.openBlock(), vueExports.createElementBlock("div", ip, [
...
function gp(e, t, r, n, i, s) {
  return vueExports.openBlock(), vueExports.createElementBlock("div", vp, [
    vueExports.renderSlot(e.$slots, "default")
  ], 512);
}
